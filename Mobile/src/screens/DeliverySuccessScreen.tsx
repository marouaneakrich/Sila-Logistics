            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.earningsCard}>
                    <View>
                        ...
                        <Text style={styles.earningsAmount}>+15 DH</Text>
                    </View>
                ...
                <View style={styles.summaryCard}>
                    ...
                    <View style={styles.summaryRow}>
                        ...
                        <View style={styles.summaryTextContainer}>
                            <Text style={styles.summaryLabel}>Time on Road</Text>
                            <Text style={styles.summarySubtext}>Driving & drop-offs</Text>
                        </View>
                    ...
                    <View style={styles.summaryRow}>
                        ...
                        <Text style={[styles.summaryValue, { color: COLORS.primary }]}>180 DH</Text>
                    </View>
                </View>
